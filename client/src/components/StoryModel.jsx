...
const StoryModel = ({setShowModal ,fetchStories }) => {
    ...
    const bgColors= ["#4e45ff","#4f46e5","#7c3aed" ,"#db2777","#e11d48","#ca8a04","#0d9488","#cc0808"]
        ...
        <div className='w-full max-w-md'>
            ...
            <div className='flex mt-4 gap-2'>
                {bgColors.map((color)=>(
                    ...
                    cursor-pointer' style={{backgroundColor:color}} onClick={()=> setBackground(color)}/>
                ))}
            </div>
            
            <div className='flex gap-2 mt-4'>
                <button onClick={()=> {setMode('text'); setMedia(null) ;
                    setPreviewUrl(null)}} className={`flex-1 flex items-center justify-center gap-2 p-2 rounded cursor-pointer ${mode === 'text' ? "bg-white text-black" :"bg-zinc-800" }`}>
            ...
            py-3 mt-4 w-full rounded bg-gradient-to-r from-indigo-500 to-purple-600 hover:from-indigo-600 hover:to-purple-700

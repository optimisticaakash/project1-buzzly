...
const Sidebar = ({SidebarOpen , setSidebarOpen}) => {
  ...
  return (
    ...
    justify-between items-center max-sm:absolute top-0 bottom-0 -20 ${SidebarOpen ? 'translate-x-0' : 'max-sm:-translate-x-full'} transition-all 
    duration-300 ease-in-out`}>
        <div className='w-full'>
            ...
            gap-2 py-2.5 mt-6 mx-6 rounded-lg bg-gradient-to-r from-indigo-500 to-blue-600 

            ...
            <div className='bg-white rounded-lg shadow p-6'>
                ...
                <form className='space-y-4' onSubmit={e => toast.promise(
                            ...
                            <input hidden type="file" accept='image/*' id='profile_picture'
                             ...
                             <div className='group/profile relative'>
                                <img src={editForm.profile_picture ? URL.createObjectURL(
                                 editForm.profile_picture) : user.profile_picture} alt=""  className='w-24 h-24 rounded-full object-cover mt-2'/>
                    ...
                    <div>
                        ...
                        <input type='text' className='w-full p-3 border border-gray-200 rounded-lg' 
                            placeholder='Please enter your a username' onChange={(e)=>setEditForm({...editForm,username: e.target.value})} 
                    ...
                    <div>
                        ...
                        <textarea rows={3}  className='w-full p-3 border border-gray-200 rounded-lg' 
                            placeholder='Please enter a short bioi' onChange={(e)=>setEditForm({...editForm,bio: e.target.value})} 
                            value={editForm.bio}/>
                    </div>
                    ...
                    <div className='flex justify-end space-x-3 pt-6'>
                        ...
                        to-blue-600 text-white rounded-lg hover:from-indigo-600 
                        hover:to-blue-700 transition cursor-pointer'>
                            Save Changes
                        </button>
                    </div>
                </form>

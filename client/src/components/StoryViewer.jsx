...
export const StoryViewer = ({viewStory , setViewStory}) => {
        ...
        case 'image':
         ...
         case 'text':
            return (
                ...
                items-center justify-center p-8 text-white text-2xl text-center'>
                    {viewStory.content}
                </div>
            );
  ...
  return (
    ...
    z-110 flex items-center justify-center' style={{backgroundColor : viewStory.media_type === 'text' ? viewStory.background_color : '#000000' }} >

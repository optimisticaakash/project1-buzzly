    ...
    <div className='flex flex-col h-screen'>
        ...
        <div className='space-y-4 max-w-4xl mx-auto'>
          {
            messages.toSorted((a,b)=> new Date(a.createdAt) - new Date(b.createdAt)).map((message,index) => (
              ...
              `}>
                <div className={`p-2 text-sm max-w-sm bg-white text-slate-700 rounded-lg-shadow ${message.to_user_id !== user._id  ? 'rounded-b;-none' : 'rounded-br-none'}`}>
      ...
      <div className='px-4'>
          ...
          max-w-xl mx-auto border border-gray-200 shadow rounded-full mb-5'>
            ...
            <button onClick={sendMessage} className='bg-gradient-to-br from-indigo-500 to-blue-600 
            hover:from-indigo-700 hover:to-blue-800 active:scale-95
